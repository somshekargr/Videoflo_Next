...
import IcaStyles from "./ImageCaptureActivity.module.css";
...
export default function ImageCaptureActivity(props) {
        ...
        <Grid container>
          <Grid item sx={{ width: "100%" }}>
            <Box>
              <Paper elevation={3}>
                <Card>
                  <CardContent className={IcaStyles.panHeader}>
                  ...
                  {isAgent() && (
                    <>
                      <CardContent
                        className={IcaStyles.panActionContent}
                        sx={{ pb: 0 }}
                      >
                        {isWaiting && (
                          <Box sx={{ width: "100%" }}>
                        ...
                        {base64ImageOfLocalUser && (
                          <>
                            ...
                            <div>
                              <img
                                className={IcaStyles.capturedPanCard}
                        ...
                        {!isWaiting && (
                          <CardActions direction="row" spacing={1}>
                            <Button
                              variant="contained"
                              className={IcaStyles.captureBtn}
                                ...
                                <>
                                  ...
                                  >
                                    <Stack
                                      spacing={1}
                                      direction="row"
                                      className={IcaStyles.combobtns}
                                    >
                                      <Button
                                        variant="contained"
                                        className={IcaStyles.errorbtn}
